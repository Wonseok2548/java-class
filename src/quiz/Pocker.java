...
public class Pocker {
	...
	// PockerHand 클래스를 구현해보세요.
	
	// 1. 다섯장의 PockerCard를 가지고 있어야 함.
	
	// 2. 다섯장의 PockerCard의 숫자/무늬를 통해 족보를 완성해야 함.
	
	// 3. 다른 PockerHand 인스턴스와 족보를 통한 크기비교가 가능해야 함.
	
	// 4. 다섯장 중 원하는 카드만 공개하는 기능이 있어야 함.
	
	// 5. PockerDeck에서 카드를 한장씩 추가하는 기능이 있어야 함.
    ...
    public static void main(String[] args) {
        ...
        switch(grade){
        case 1:
            System.out.println("당신은 "+gradeResult(top)+" <High Card> 입니다.");
            break;
        case 2:
