...
public class D10_Regex {
	...
	public static void main(String[] args) {
		...
		System.out.println(Pattern.matches("s[^1-9]eep", "s11eep"));
		...
		System.out.println(Pattern.matches(".....", "abcdefg"));
		
		// # ÇØ´ç ÆĞÅÏÀÌ Àû¿ëµÉ ¹®ÀÚÀÇ °³¼ö¸¦ Á¤ÀÇÇÏ´Â ¹æ¹ı
		//	1. Ex{n}	: ¾Õ¿¡ ÀÖ´Â ÆĞÅÏÀÌ n±ÛÀÚ Àû¿ëµÈ´Ù. - ¡Ø °ø¹éÀÌ ¾ø¾î¾ß ÇÔ
		//	2. Ex{n,m}	: ¾Õ¿¡ ÀÖ´Â ÆĞÅÏÀÌ ÃÖ¼Ò n±ÛÀÚ ÀÌ»ó ÃÖ´ë m±ÛÀÚ Àû¿ëµÇ¾î¾ß ÇÔ.
		//	3. Ex{n,}	: ¾Õ¿¡ ÀÖ´Â ÆĞÅÏÀÌ ÃÖ¼Ò n±ÛÀÚ ÀÌ»ó ÀÏÄ¡ÇØ¾ß ÇÔ.
		//	4. Ex?		: 0¹ø È¤Àº ÇÑ¹ø
		//	5. Ex+		: ÃÖ¼Ò ÇÑ¹ø ÀÌ»ó
		//	6. Ex*		: 0¹ø È¤Àº ¿©·¯¹ø
		System.out.println(Pattern.matches("....[\\d]{4}", "abfd1234"));
		System.out.println("À¯È¿ÇÑ ¾ÆÀÌµğ : " + Pattern.matches("[\\w°¡-ÆR]{2,12}", "°¡°¡°¡°¡°¡°¡°¡°¡°¡°¡"));
		System.out.println(Pattern.matches("....[\\d]{4,}", "abfd1234"));
		...
		// # »ı¼ºµÈ ÆĞÅÏ ÀÎ½ºÅÏ½º·Î matcher »ı¼ºÇÏ±â
		
		// # java.util.regex.Matcher
		//	- ¹®ÀÚ¿­À» Ã³À½ºÎÅÍ ³¡±îÁö °Ë»çÇÏ¸é¼­ 
		//	  ÇØ´ç Á¤±Ô½ÄÇ¥Çö°ú ÀÏÄ¡ÇÏ´Â ÀÎµ¦½º¸¦ Ã£Àº °á°ú
