...
public class C07_accessModifier extends C07_diffPackage{
	...
	// # 접근 제어자의 종류
	//	- private	: 같은 클래스 내부에서만 사용할 수 있는 자원이 된다. (가장 폐쇄적인 접근제어자)
	//	- 아무것도 안씀 : default. 같은 패키지 내부에서만 사용할 수 있는 자원이 된다. (다른 패키지에서는 사용할 수 없다.)
	...
	public static void main(String[] args) {
		...
		// # 다른 패키지의 자원은 상속받으면 protected까지 보인다. (visible)
