...
public class D02_HashSet {
	...
	public static void main(String[] args) {
		...
		// HashSet은 index가 없기때문에 하나만 꺼낼 수가 없다.
		for (int i : even) {
		...
		// contains : 컬렉션에 해당 요소가 있는지 여부를 boolean타입으로 반환한다.
		...
		// remove : 컬렉션 요소 삭제 (삭제 성공시 true로 반환, 실패시 false반환)
		...
		// 3. retailAll(collection) : 전달한 컬렉션과 일치하는 값만 유지한다.
