...
public class D03_LinkedList {
	...
	//	  LinkedList는 연결된 노드만 바꾸면 되기때문에 훨씬 빠르다.
	//	- ArrayList는 데이터 보관, 읽기에 유리하고 (데이터의 변동이 없을 때)
	//	  LinkedList는 데이터 추가 및 삭제에 유리하다. (데이터의 변동이 있을 때)
	...
	public static void main(String[] args) {
		...
		System.out.println("ArrayList Ended " + (end-start) + "밀리초");
		...
		//더 이상 추가/삭제가 일어나지 않을 데이터를 ArrayList로 반환하여 보관
