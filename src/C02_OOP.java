...
public class C02_OOP {
	...
	public static void main(String[] args) {
		...
		// Scanner 설계도로 실체(Scanner의 인스턴스)를 만들어
		// 그 실체의 주소를 변수 sc에 저장
		...
		// 클래스 타입 배열을 만든 시점에는 인스턴스가 생성되지 않았다.
		// (배열의 실체만 생성됨)
		...
		// 실체가 생겼으므로 미리 만들어 둔 설계도 대로 사용할 수 있다.
		...
		System.out.println("============================================");
		// 1. myobj.fruit 패키지에 클래스 하나 정의하고 인스턴스를 생성해보세요.
...
// 들여쓰기를 잘 맞춰놨다면 중괄호만 보고도 클래스 바깥인 것을 짐작할 수 있다.
