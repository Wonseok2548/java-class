...
public class PokerHandRanking {	
	...
	public PokerHandRanking(PokerHand hands) {
		rankCount = new ArrayList<>(Rank.NUM_OF_RANK);		//	NUM_OF_RANK = 13
		suitCount = new ArrayList<>(Suit.NUM_OF_SUIT);		// 	NUM_OF_SUIT = 4
	...
	public void check(PokerHand player) {
		...
		else if (rankCount.contains(5) && checkStraight(ranks)) {
